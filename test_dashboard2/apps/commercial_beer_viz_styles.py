    ...
    [
        ...
        html.Div(
            [
                html.Div(
                    [
                        dcc.Graph(id='main_graph_by_style')
                    ],
                    ...
                    [
                        ...
                        html.Div(
                            [
                                ...
                                dcc.RadioItems(
                                    id='beer_style_selector_by_style',
                                    options=[
                                        # {'label': 'All ', 'value': 'all'},
                                ...
                                dcc.Dropdown(
                                    id='beer_style_dropdown_by_style',
...
@app.callback(Output('brewery_dropdown_by_style', 'options'),
              [Input('rating_slider_by_style', 'value'),
              Input('ibu_slider_by_style', 'value'),
              Input('abv_slider_by_style', 'value'),
              Input('beer_style_dropdown_by_style', 'value')])
...
# WORKING
# Radio -> multi
@app.callback(Output('beer_style_dropdown_by_style', 'value'),
              [Input('beer_style_selector_by_style', 'value')])
...
# WORKING
# Radio -> multi
@app.callback(Output('brewery_dropdown_by_style', 'value'),
              [Input('brewery_selector_by_style', 'value'),
              Input('rating_slider_by_style', 'value'),
              Input('ibu_slider_by_style', 'value'),
              Input('abv_slider_by_style', 'value'),
              Input('beer_style_dropdown_by_style', 'value')])
...
@app.callback(Output('main_graph_by_style', 'figure'),
              [Input('rating_slider_by_style', 'value'),
              Input('ibu_slider_by_style', 'value'),
              Input('abv_slider_by_style', 'value'),
              Input('beer_style_dropdown_by_style', 'value'),
              Input('brewery_dropdown_by_style', 'value'),
              Input('color_selector_by_style', 'value')])
